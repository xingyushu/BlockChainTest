    ...
    >
      ...
      <el-table-column label="Actions" align="center" width="230" class-name="small-padding fixed-width">
        <template slot-scope="{row}">
          ...
          <el-button v-if="row.status!='running'" size="mini" type="success" @click="handleModifyStatus(row,'running')">
            运行
          </el-button>
          <el-button v-if="row.status!='stopped'" size="mini" @click="handleModifyStatus(row,'stopped')">
            停止
          </el-button>
...
export default {
  ...
  data() {
    return {
      ...
      statusOptions: ['BTC', 'ETH', 'Fabric', 'Swarm', 'Iroha', 'Fisco Bcos', 'Xuperchain', 'Burrow', 'Parity'],
      showReviewer: false,
      temp: {
        id: undefined,
        importance: 1,
